...
const ja: TranslationKeys = {
  ...
  update_later: '後で',
  promo_invite_title: '招待して特典をゲット',
  promo_invite_body: '友達をKiramoPayに招待しよう。リンクを共有すれば数分で開始でき、招待ごとに特典が貯まります。',
  promo_invite_cta: '共有する',
  promo_share_text: 'KiramoPayを試してみて：お金を即時に送受金。',
