...
const hi: TranslationKeys = {
  ...
  promo_invite_title: 'अपने दोस्तों को आमंत्रित करें',
  promo_invite_body: 'KiramoPay पर और लोगों के साथ तुरंत पैसे भेजें और पाएं। लिंक साझा करें, मिनटों में तैयार।',
