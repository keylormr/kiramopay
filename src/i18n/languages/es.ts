...
const es: TranslationKeys = {
  ...
  promo_invite_title: 'Invitá y ganá beneficios',
  promo_invite_body: 'Traé a tus amigos a KiramoPay: compartiles el enlace, quedan listos en minutos y vos acumulás beneficios por cada invitado.',
  promo_invite_cta: 'Compartir',
  promo_share_text: 'Probá KiramoPay: enviá y recibí plata al instante.',
