...
const es: TranslationKeys = {
  ...
  business_report_daily: 'Ventas por dia',
  business_report_net: 'Neto del periodo',
  business_report_sales: 'Ventas',
  business_report_commission: 'Comision',
  business_report_by_location: 'Por local',
  business_report_by_collector: 'Por cajero',
  business_report_unattributed: 'Sin atribuir',
  business_report_empty: 'Sin ventas en este periodo',
  ...
  crypto_up_to_apy: 'El programa de rendimientos se activara proximamente',
  crypto_since: 'Desde',
  ...
  loyalty_earn: 'Ganar',
  loyalty_earn_desc: 'El programa de puntos se activara proximamente, financiado por el margen real de las operaciones',
  ...
  plan_pro_desc: 'Sin comision entre bancos, mejor tipo de cambio y limites maximos',
  home_split: 'Dividir',
  ...
  assistant_quota_reached: 'Alcanzaste tu límite diario del asistente. Vuelve a intentarlo mañana.',
