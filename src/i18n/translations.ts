...
export type TranslationKeys = {
  ...
  plans_intro: string;
  plans_calc_title: string;
  plans_calc_label: string;
  plans_calc_note: string;
  plans_calc_best: string;
  plans_calc_breakdown_rate: string;
  plans_calc_breakdown_fee_only: string;
  plans_calc_breakdown_fee_plus: string;
  plans_calc_verdict_free: string;
  plans_calc_verdict_paid: string;
  plans_section_title: string;
  plans_billing_monthly: string;
  plans_billing_yearly: string;
  plans_billing_hint: string;
  plans_per_month: string;
  plans_per_year: string;
  plans_or_yearly: string;
  plans_yearly_equivalent: string;
  plans_free_price: string;
  plans_free_forever: string;
  plans_recommended: string;
  plans_current_plan: string;
  plans_free_name: string;
  plans_free_tagline: string;
  plans_free_highlight: string;
  plans_free_highlight_note: string;
  plans_free_f1: string;
  plans_free_f2: string;
  plans_free_f3: string;
  plans_free_f4: string;
  plans_free_f5: string;
  plans_free_f6: string;
  plans_free_f7: string;
  plans_free_f8: string;
  plans_business_name: string;
  plans_business_tagline: string;
  plans_business_includes: string;
  plans_business_highlight: string;
  plans_business_highlight_note: string;
  plans_business_f1: string;
  plans_business_f2: string;
  plans_business_f3: string;
  plans_business_f4: string;
  plans_business_f5: string;
  plans_business_f6: string;
  plans_business_f7: string;
  plans_business_f8: string;
  plans_peak_name: string;
  plans_peak_tagline: string;
  plans_peak_includes: string;
  plans_peak_highlight: string;
  plans_peak_highlight_note: string;
  plans_peak_f1: string;
  plans_peak_f2: string;
  plans_peak_f3: string;
  plans_peak_f4: string;
  plans_peak_f5: string;
  plans_peak_f6: string;
