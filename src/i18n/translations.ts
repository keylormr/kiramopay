...
export type TranslationKeys = {
  ...
  // Centro de ayuda: indice buscable + temas de las funciones de Inicio
  help_search_ph: string;
  help_no_results: string;
  help_no_results_desc: string;
  help_cat_all: string;
  help_cat_features: string;
  help_cat_general: string;
  help_cat_send: string;
  help_cat_limits: string;
  help_cat_payments: string;
  help_cat_security: string;
  help_savings_title: string;
  help_savings_body: string;
  help_splitpay_title: string;
  help_splitpay_body: string;
  help_marketplace_title: string;
  help_marketplace_body: string;
  help_cards_title: string;
  help_cards_body: string;
  help_assistant_title: string;
  help_assistant_body: string;
  faq_q1: string;
  faq_a1: string;
  faq_q2: string;
  faq_a2: string;
  ...
  bio_offer_title: string;
  bio_offer_desc: string;
  bio_offer_accept: string;
  bio_offer_later: string;
  ...
  business_report_loading: string;
  business_report_updating: string;
  business_report_err_load: string;
  ...
  crypto_alerts_title: string;
  crypto_alert_new: string;
  crypto_alerts_see_all: string;
  crypto_alerts_open: string;
  crypto_alerts_open_aria: string;
  crypto_alert_from_asset: string;
  crypto_alert_asset: string;
  crypto_alert_when: string;
  crypto_alert_above: string;
  crypto_alert_below: string;
  crypto_alert_target: string;
  crypto_alert_now: string;
  crypto_alert_now_unavailable: string;
  crypto_alert_diff_above: string;
  crypto_alert_diff_below: string;
  crypto_alert_met_above: string;
  crypto_alert_met_below: string;
  crypto_alert_use_below: string;
  crypto_alert_use_above: string;
  crypto_alert_create: string;
  crypto_alert_created: string;
  crypto_alerts_active: string;
  crypto_alerts_count: string;
  crypto_alerts_triggered: string;
  crypto_alerts_empty_title: string;
  crypto_alerts_empty: string;
  crypto_alert_row_above: string;
  crypto_alert_row_below: string;
  crypto_alert_row_created: string;
  crypto_alert_row_triggered: string;
  crypto_alert_row_reached_above: string;
  crypto_alert_row_reached_below: string;
  crypto_alert_remove_aria: string;
  crypto_alerts_load_error: string;
  crypto_alert_err_limit: string;
  crypto_alert_err_already_met: string;
  crypto_alert_err_out_of_range: string;
  crypto_alert_err_unsupported: string;
  crypto_alert_err_create: string;
  crypto_alert_err_remove: string;
  crypto_alerts_how: string;
  crypto_alerts_how_price: string;
  ...
  reg_usuario_title: string;
  reg_usuario_desc: string;
  reg_usuario_placeholder: string;
  reg_usuario_regla: string;
  reg_usuario_tomado: string;
  reg_usuario_invalido: string;
  ...
  analytics_dir_all: string;
  analytics_dir_in: string;
  ...
  profile_finance_section: string;
  budget_title: string;
  budget_menu_desc: string;
  budget_manual_note: string;
  budget_summary_label: string;
  budget_summary_of: string;
  budget_empty_title: string;
  budget_empty_desc: string;
  budget_new: string;
  budget_edit: string;
  budget_field_name_placeholder: string;
  budget_field_limit: string;
  budget_icon_food: string;
  budget_icon_transport: string;
  budget_icon_home: string;
  budget_icon_utilities: string;
  budget_icon_shopping: string;
  budget_icon_health: string;
  budget_icon_fun: string;
  budget_icon_education: string;
  budget_add_expense: string;
  budget_add_expense_hint: string;
  budget_add_expense_btn: string;
  budget_left: string;
  budget_over: string;
  budget_spent_of: string;
  budget_reset: string;
  budget_reset_desc: string;
  budget_reset_btn: string;
  budget_delete_title: string;
  budget_delete_desc: string;
  budget_err_load: string;
  budget_err_save: string;
  budget_err_delete: string;
  budget_err_reset: string;
  budget_err_label_required: string;
  budget_err_label_too_long: string;
  budget_err_amount: string;
  budget_err_not_found: string;
  recurring_title: string;
  recurring_menu_desc: string;
  recurring_manual_note: string;
  recurring_empty_title: string;
  recurring_empty_desc: string;
  recurring_new: string;
  recurring_field_name: string;
  recurring_field_name_placeholder: string;
  recurring_field_type: string;
  recurring_type_service: string;
  recurring_type_sinpe: string;
  recurring_type_recharge: string;
  recurring_field_frequency: string;
  recurring_freq_weekly: string;
  recurring_freq_biweekly: string;
  recurring_freq_monthly: string;
  recurring_field_next: string;
  recurring_next: string;
  recurring_overdue: string;
  recurring_last_paid: string;
  recurring_mark_paid: string;
  recurring_mark_paid_title: string;
  recurring_mark_paid_desc: string;
  recurring_mark_paid_confirm: string;
  recurring_section_active: string;
  recurring_section_paused: string;
  recurring_pause: string;
  recurring_resume: string;
  recurring_delete_title: string;
  recurring_delete_desc: string;
  recurring_err_load: string;
  recurring_err_save: string;
  recurring_err_action: string;
  recurring_err_label_required: string;
  recurring_err_label_too_long: string;
  recurring_err_amount: string;
  recurring_err_date: string;
  recurring_err_not_found: string;
  ...
  qr_mi_codigo: string;
  qr_rotulo_mostrador: string;
  qr_rotulo_ayuda: string;
  qr_cobrar_monto: string;
  qr_cobrando: string;
  qr_vence_en_min: string;
  qr_cambiar_monto: string;
  qr_quitar_monto: string;
  qr_cancelar_cobro: string;
  qr_siguiente_cliente: string;
  qr_pagado: string;
  qr_le_pagas_a: string;
  qr_verificando: string;
  qr_solicitudes_activas: string;
  qr_sin_solicitudes: string;
  qr_err_revocado: string;
  qr_err_reemplazado: string;
  ...
  // Bloqueo remoto de cuentas: consola admin + aviso al usuario expulsado
  admin_users_menu: string;
  admin_users_menu_desc: string;
  admin_users_title: string;
  admin_users_tab_search: string;
  admin_users_tab_blocked: string;
  admin_users_search_placeholder: string;
  admin_users_search_hint: string;
  admin_users_search_action: string;
  admin_users_empty: string;
  admin_users_no_blocked: string;
  admin_users_status_active: string;
  admin_users_status_blocked: string;
  admin_users_status_suspended: string;
  admin_users_status_closed: string;
  admin_users_block: string;
  admin_users_unblock: string;
  admin_users_block_title: string;
  admin_users_block_reason: string;
  admin_users_block_reason_hint: string;
  admin_users_block_warning: string;
  admin_users_block_confirm: string;
  admin_users_unblock_title: string;
  admin_users_unblock_warning: string;
  admin_users_unblock_confirm: string;
  admin_users_blocked_at: string;
  admin_users_blocked_by: string;
  admin_users_blocked_reason_label: string;
  admin_users_last_login: string;
  admin_users_never: string;
  admin_users_action_failed: string;
  admin_users_err_self: string;
  admin_users_err_admin: string;
  admin_users_err_reason: string;
  admin_users_expiry: string;
  admin_users_expires_at: string;
  admin_users_expired: string;
  admin_users_expiry_title: string;
  admin_users_expiry_hint: string;
  admin_users_expiry_in_1d: string;
  admin_users_expiry_in_7d: string;
  admin_users_expiry_in_30d: string;
  admin_users_expiry_past: string;
  admin_users_expiry_save: string;
  admin_users_expiry_clear: string;
  admin_users_err_expiry: string;
  admin_users_err_expire_admin: string;
  ...
  // Plazos del escrow y panel del arbitro.
  escrow_deliver: string;
  escrow_delivered_badge: string;
  escrow_deliver_by_seller: string;
  escrow_deliver_by_buyer: string;
  escrow_review_by_buyer: string;
  escrow_review_by_seller: string;
  escrow_dispute_note: string;
  ...
  admin_disputes_empty: string;
  admin_disputes_total: string;
  admin_disputes_opened: string;
  admin_disputes_delivered: string;
  admin_disputes_reason: string;
  admin_disputes_buyer: string;
  admin_disputes_seller: string;
  admin_disputes_to_buyer: string;
  admin_disputes_to_seller: string;
  admin_disputes_confirm_buyer: string;
  admin_disputes_confirm_seller: string;
  admin_disputes_confirm: string;
  admin_disputes_failed: string;
  payout_menu: string;
  ...
  apikeys_err_load: string;
  apikeys_err_create: string;
  apikeys_err_revoke: string;
  apikeys_err_not_found: string;
  ...
  webhooks_err_load: string;
  webhooks_err_create: string;
  webhooks_err_delete: string;
  webhooks_err_not_found: string;
  webhooks_err_deliveries: string;
  ...
  plans_menu: string;
  plans_menu_desc: string;
  plans_title: string;
  plans_intro_title: string;
  plans_intro: string;
  plans_jump_label: string;
  plans_personal_title: string;
  plans_personal_desc: string;
  plans_name_free: string;
  plans_name_plus: string;
  plans_name_pro: string;
  plans_per_month: string;
  plans_badge_current: string;
  plans_badge_soon: string;
  plans_row_assistant: string;
  plans_row_goals: string;
  plans_row_cards: string;
  plans_row_cards_note: string;
  plans_unlimited: string;
  plans_keep_note: string;
  plans_same_title: string;
  plans_same_1: string;
  plans_same_2: string;
  plans_same_3: string;
  plans_same_4: string;
  ...
  plans_business_title: string;
  plans_business_desc: string;
  plans_business_rate: string;
  plans_business_rate_note: string;
  plans_business_p2p: string;
  plans_promo_title: string;
  plans_promo_desc: string;
  plans_promo_existing: string;
  plans_analytics_name: string;
  plans_analytics_tag: string;
  plans_analytics_desc: string;
  plans_analytics_f1: string;
  plans_analytics_f2: string;
  plans_excluded_title: string;
  plans_excluded_desc: string;
  plans_excluded_1: string;
  plans_excluded_2: string;
  plans_excluded_3: string;
  plans_excluded_4: string;
  plans_excluded_5: string;
  ...
  plans_limit_goals_one: string;
  plans_limit_goals_many: string;
  plans_limit_cards_one: string;
  plans_limit_cards_many: string;
  plans_limit_next: string;
  plans_limit_next_unlimited: string;
  plans_limit_top: string;
  plans_limit_keep: string;
  plans_limit_frozen: string;
  ...
  business_commission_set: string;
  business_promo_until: string;
  business_promo_ended: string;
  business_merchant_id: string;
  business_merchant_id_hint: string;
  business_merchant_id_copied: string;
  business_plan_label: string;
  business_plan_base: string;
  business_plan_analitica: string;
  business_report_compare_title: string;
  business_report_compare_range: string;
  business_report_compare_prev: string;
  business_report_compare_no_base: string;
  business_report_export: string;
  business_report_exporting: string;
  business_report_exported: string;
  business_report_export_failed: string;
  business_report_export_plan: string;
  business_report_export_web_only: string;
  business_report_locked_title: string;
  business_report_locked_desc: string;
  business_report_locked_preview: string;
  // Administrador: plan de una persona y de un comercio
  admin_users_plan: string;
  admin_users_plan_title: string;
  admin_users_plan_hint: string;
  admin_users_plan_lower_note: string;
  admin_users_plan_current: string;
  admin_users_plan_confirm: string;
  admin_users_plan_done: string;
  admin_users_err_not_found: string;
  admin_users_err_rate: string;
  admin_users_err_plan: string;
  merchant_admin_tab_pending: string;
  merchant_admin_tab_plan: string;
  merchant_admin_plan_desc: string;
  merchant_admin_plan_id_label: string;
  merchant_admin_plan_id_invalid: string;
  merchant_admin_plan_base_desc: string;
  merchant_admin_plan_analitica_desc: string;
  merchant_admin_plan_review: string;
  merchant_admin_plan_confirm_title: string;
  merchant_admin_plan_confirm_body: string;
  merchant_admin_plan_confirm: string;
  merchant_admin_plan_done: string;
  merchant_admin_plan_not_found: string;
  merchant_admin_plan_failed: string;
