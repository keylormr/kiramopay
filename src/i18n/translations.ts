...
export type TranslationKeys = {
  ...
  help_webhooks_body: string;
  help_staking_title: string;
  help_staking_body: string;
  help_mfa_title: string;
  help_mfa_body: string;
  help_loyalty_title: string;
  help_loyalty_body: string;
  help_payout_title: string;
  help_payout_body: string;
  help_kyc_title: string;
  help_kyc_body: string;
  kyc_n2_soon: string;
  cat_all: string;
  ...
  business_create: string;
  business_create_desc: string;
  business_movements: string;
  ...
  business_role_manager_desc: string;
  business_role_cashier_desc: string;
  business_revoke: string;
  business_revoked: string;
  business_locations: string;
  business_locations_empty: string;
  business_location_add: string;
  business_location_deactivate: string;
  business_location_activate: string;
  business_catalog: string;
  business_catalog_empty: string;
  business_catalog_add: string;
  business_catalog_price: string;
  business_catalog_delete: string;
  ...
  business_next: string;
  card_no_cards_title: string;
  card_no_cards_desc: string;
  card_create: string;
  card_holder: string;
  card_frozen_label: string;
  card_controls: string;
  card_freeze: string;
  card_unfreeze: string;
  card_freeze_desc: string;
  card_limits_title: string;
  card_limits_desc: string;
  card_cancel: string;
  card_cancel_confirm: string;
  ...
  home_cards: string;
  home_cards_view: string;
  home_cards_desc: string;
  used: string;
  new_pin: string;
  ...
  crypto_minutes_ago: string;
  crypto_hours_ago: string;
  crypto_tx_buy: string;
  crypto_tx_sell: string;
  crypto_tx_send: string;
  crypto_tx_receive: string;
  crypto_tx_convert: string;
  crypto_tx_unstake: string;
  ...
  crypto_market_cap_short: string;
  crypto_volume_short: string;
  crypto_staking_positions: string;
  crypto_up_to_apy: string;
  crypto_since: string;
  ...
  crypto_sell_and_receive: string;
  ...
  merchant_cat_restaurant: string;
  merchant_cat_retail: string;
  merchant_cat_services: string;
  merchant_cat_food_truck: string;
  merchant_cat_market: string;
  merchant_status_pending: string;
  merchant_status_verified: string;
  merchant_status_rejected: string;
  merchant_status_pending_help: string;
  merchant_commission: string;
  merchant_generate_qr: string;
  merchant_qr_fixed: string;
  merchant_qr_dynamic: string;
  merchant_qr_amount: string;
  merchant_qr_amount_hint: string;
  ...
  merchant_admin_menu: string;
  merchant_admin_menu_desc: string;
  merchant_admin_title: string;
  merchant_admin_subtitle: string;
  merchant_admin_empty: string;
  merchant_admin_approve: string;
  merchant_admin_reject: string;
  merchant_admin_reject_reason: string;
  merchant_admin_action_failed: string;
  escrow_title: string;
